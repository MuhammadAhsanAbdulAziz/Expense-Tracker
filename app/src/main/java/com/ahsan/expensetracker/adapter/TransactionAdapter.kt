package com.ahsan.expensetracker.adapter
...
import com.ahsan.expensetracker.databinding.ItemTransactionLayoutBinding
        ...
        holder.binding.apply {
            ...
            when (item.transactionType) {
                "Income" -> {
                    ...
                    transactionAmount.text = "+ ".plus(pakistaniRupee(item.amount))
                }
                "Expense" -> {
                    transactionAmount.setTextColor(
                        ContextCompat.getColor(
